...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Swimming Workout Organizer by Lanes" },
      { name: "description", content: "Swim Plan Studio is a web tool for creating and managing custom swimming workouts." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Swimming Workout Organizer by Lanes" },
      { property: "og:description", content: "Swim Plan Studio is a web tool for creating and managing custom swimming workouts." },
